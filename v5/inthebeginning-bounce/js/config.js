/**
 * Configuration constants for Cosmic Runner V5.
 */
...
const EPOCH_NAMES = [
  'Quantum Fluctuation', 'Inflation', 'Quark-Gluon Plasma', 'Nucleosynthesis',
  'Recombination', 'Dark Ages', 'First Stars', 'Galaxy Formation',
  'Solar Ignition', 'Hadean Earth', 'Abiogenesis', 'Emergence of Life',
];

const SPACETIME_SCALE = 1.38e10;

const SCORE = { HIT_OBJECT: 1, JUMP_OVER: 3 };
...
const PLAYER1_DEFAULT_POS = 0.5;  // center for v5 since objects come from top
const PLAYER2_DEFAULT_POS_LEFT = 0.35;
const PLAYER2_DEFAULT_POS_RIGHT = 0.65;
const PLAYER_POS_MIN_1P = 0.10;
const PLAYER_POS_MAX_1P = 0.90;
const PLAYER_POS_MIN_2P = 0.10;
const PLAYER_POS_MAX_2P = 0.90;
const PLAYER_MIN_SEPARATION = 0.08;
